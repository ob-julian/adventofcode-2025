...
>Note: The runtimes are measured on my local machine using the included [average_runtime.py](./average_runtime.py) script. It measures raw execution time without any writing to console or files.